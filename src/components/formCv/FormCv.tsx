...
export default function FormCv({
    ...
    return (
        <form onSubmit={onSubmit}>
            ...
            <SectionSkills cvId={cv.id} skills={skills} setSkills={setSkills} />
            ...
            <Section
                title="Contribuciones técnicas y proyectos"
                className="mb-2"
            >
                <SimpleEditor
                    content={cv.technical_contributions_projects}
                    setContent={(content) =>
                        setCv({
                            ...cv,
                            technical_contributions_projects: content,
                        })
                    }
                />
            </Section>
