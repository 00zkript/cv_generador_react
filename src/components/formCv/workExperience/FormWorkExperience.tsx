...
export default function FormWorkExperience({ workExperience, updateWorkExperience } : FormWorkExperienceProps) {
    ...
    const addAchievement = () => {
        ...
        const newAchievements = [ ...workExperience.achievements, newAchievement];
        updateWorkExperience({ ...workExperience, achievements: newAchievements });
    }

    const updateAchievementDescription = (index: number, achievementItem: AchievementBase,  newAchievementDescription: AchievementBase['description']) => {
        const newAchievements = workExperience.achievements.map( (prev,i) => i === index ? { ...achievementItem, description: newAchievementDescription} : prev)
        updateWorkExperience({ ...workExperience, achievements: newAchievements });
    }

    const removeAchievement = (index: number) => {
        const newAchievements = workExperience.achievements.filter((_, i) => i !== index);
        updateWorkExperience({ ...workExperience, achievements: newAchievements });
    }
